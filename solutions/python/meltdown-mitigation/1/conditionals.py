...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    """
    temp_status = temperature * neutrons_produced_per_second
    if temp_status / threshold < 0.90:
        return 'LOW'
    elif (temp_status / threshold) >= 0.90 and (temp_status / threshold) <= 1.1:
        return 'NORMAL'
    elif temp_status / threshold > 1.1:
        return 'DANGER'
